package projectCove;
/*
 * Hunter Baldwin Monster class. Handles the created monsters (skeletons) and
 * their attributes. As well deals with player drops from the monster.
 */
...
public class Monster extends ProjectCove
{
	...
	/*** Create a new skeleton based off the level.at*/
